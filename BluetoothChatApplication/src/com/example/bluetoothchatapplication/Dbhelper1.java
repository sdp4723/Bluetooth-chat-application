...
public class Dbhelper1 extends SQLiteOpenHelper {
	...
	static String database_name="Application1";
	String table_name="device1";
	String column_1="id";
...
//	public boolean delete_message(String message){
//		db=getWritableDatabase();
//		String delete_query="delete from "+table_name+" where message="+message+";";
//		Cursor delete=db.rawQuery(delete_query,null);
//		long result=;
//	}
