...
public class Device55 extends Activity {
	...
	Handler h=new Handler(new Handler.Callback() {
		...
		public boolean handleMessage(Message msg) {
			...
			case message_read:
                ...
                db_helper55.insert_message(connecteddevice , "Me" , inpuBuffer );
				break;				
			case message_write:
				byte[] buffer1 = (byte[]) msg.obj;
                String outputBuffer = new String(buffer1);
                chat_adapter.add("Me: " + outputBuffer);
                db_helper55.insert_message("Me" , connecteddevice , outputBuffer );
				break;				
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_device55);
		
		initialization_code();
		on_click_listeners();
		server_client_message=new ServerClientMessage(this, h);
		check();
		db_helper55=new Dbhelper55(this);
		
		if(chat_adapter.getCount()==0){
			Cursor c=db_helper55.retrieve_chat();
			if(c.getCount()==0){
	...
	public void on_click_listeners(){
		...
		chat.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
			...
			public boolean onItemLongClick(AdapterView<?> parent, View view,
				...
				new AlertDialog.Builder(Device55.this)
