...
public class Device4 extends Activity {
	...
	Handler h=new Handler(new Handler.Callback() {
		...
		public boolean handleMessage(Message msg) {
			...
			case message_read:
                ...
                //new type of data : -
                db_helper4.insert_message(connecteddevice , "Me" , inpuBuffer );
			...
			case message_write:
                ...
                //new type of data : -
                db_helper4.insert_message("Me" , connecteddevice , outputBuffer );
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_device4);
		
		initialization_code();
		on_click_listeners();
		server_client_message=new ServerClientMessage(this, h);
		check();
		db_helper4=new Dbhelper4(this);
		
		if(chat_adapter.getCount()==0){
			Cursor c=db_helper4.retrieve_chat();
			if(c.getCount()==0){
	...
	public void on_click_listeners(){
		...
		chat.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
			...
			public boolean onItemLongClick(AdapterView<?> parent, View view,
				...
				new AlertDialog.Builder(Device4.this)
